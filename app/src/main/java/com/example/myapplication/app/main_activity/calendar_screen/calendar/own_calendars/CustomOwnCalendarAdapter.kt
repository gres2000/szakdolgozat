package com.example.myapplication.app.main_activity.calendar_screen.calendar.own_calendars
...
import com.example.myapplication.app.main_activity.calendar_screen.calendar.calendar_details.CalendarDetailFragment
...
class CustomOwnCalendarAdapter(private val activity: AppCompatActivity, private val dataList: MutableList<MyCalendar>) : RecyclerView.Adapter<CustomOwnCalendarAdapter.CalendarItemViewHolder>() {
