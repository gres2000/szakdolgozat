...
class CalendarDetailFragment : Fragment(), EventDetailFragment.EventDetailListener,
    ...
    private fun acquireOutlookTokenAndExport(dialog: Dialog) {
        ...
        if (msalAccount != null) {
                ...
                override fun onSignOut() {
                    ...
                    msalApp.signIn(
                        ...
                        object : AuthenticationCallback {
                            ...
                            override fun onError(exception: MsalException) {
                                Log.e("MSAL", "Sign-in failed: ${exception.message}")
            ...
            // No signed-in account → force interactive login
            msalApp.signIn(
                requireActivity(),
                null, // no login hint
                scopes,
